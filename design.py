...
class Ui_Brunnhilde(object):
    def setupUi(self, Brunnhilde):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 21, 611, 261))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(self.diskImageTab)
        self.layoutWidget1.setGeometry(QtCore.QRect(11, 21, 611, 301))
        ...
        self.diskImageSource = QtWidgets.QLineEdit(self.layoutWidget1)
        self.diskImageSource.setObjectName("diskImageSource")
        self.horizontalLayout_4.addWidget(self.diskImageSource)
        self.diskImageSourceBtn = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.hfsDisk = QtWidgets.QCheckBox(self.layoutWidget1)
        ...
        self.diskImageDestination = QtWidgets.QLineEdit(self.layoutWidget1)
        self.diskImageDestination.setObjectName("diskImageDestination")
        self.horizontalLayout_5.addWidget(self.diskImageDestination)
        self.diskImageDestinationBtn = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.diskImageIdentifier = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.diskImageStatus = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.diskImageCancelBtn = QtWidgets.QPushButton(self.layoutWidget1)
        self.diskImageCancelBtn.setObjectName("diskImageCancelBtn")
        self.horizontalLayout_6.addWidget(self.diskImageCancelBtn)
        self.diskImageStartScan = QtWidgets.QPushButton(self.layoutWidget1)
        ...
        self.widget = QtWidgets.QWidget(self.optionsTab)
        self.widget.setGeometry(QtCore.QRect(11, 21, 422, 380))
        ...
        self.md5 = QtWidgets.QRadioButton(self.widget)
        ...
        self.sha256 = QtWidgets.QRadioButton(self.widget)
        ...
        self.removeFiles = QtWidgets.QCheckBox(self.widget)
        self.removeFiles.setObjectName("removeFiles")
        self.verticalLayout_3.addWidget(self.removeFiles)
        self.resForks = QtWidgets.QCheckBox(self.widget)
        ...
        self.scanArchives = QtWidgets.QCheckBox(self.widget)
