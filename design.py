...
class Ui_Brunnhilde(object):
    def setupUi(self, Brunnhilde):
        ...
        Brunnhilde.resize(662, 743)
        self.tabWidget = QtWidgets.QTabWidget(Brunnhilde)
        self.tabWidget.setGeometry(QtCore.QRect(10, 20, 641, 711))
        self.tabWidget.setObjectName("tabWidget")
        self.directoryTab = QtWidgets.QWidget()
        self.directoryTab.setObjectName("directoryTab")
        self.widget = QtWidgets.QWidget(self.directoryTab)
        self.widget.setGeometry(QtCore.QRect(10, 20, 621, 651))
        ...
        self.dirSource = QtWidgets.QLineEdit(self.widget)
        self.dirSource.setObjectName("dirSource")
        self.horizontalLayout.addWidget(self.dirSource)
        self.dirSourceBtn = QtWidgets.QPushButton(self.widget)
        ...
        self.dirDestination = QtWidgets.QLineEdit(self.widget)
        self.dirDestination.setObjectName("dirDestination")
        self.horizontalLayout_2.addWidget(self.dirDestination)
        self.dirDestinationBtn = QtWidgets.QPushButton(self.widget)
        ...
        self.dirIdentifier = QtWidgets.QLineEdit(self.widget)
        ...
        self.dirOutput = QtWidgets.QTextEdit(self.widget)
        self.dirOutput.setObjectName("dirOutput")
        self.verticalLayout_8.addWidget(self.dirOutput)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setSpacing(6)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.dirCancelBtn = QtWidgets.QPushButton(self.widget)
        self.dirCancelBtn.setObjectName("dirCancelBtn")
        self.horizontalLayout_3.addWidget(self.dirCancelBtn)
        self.dirStartScanBtn = QtWidgets.QPushButton(self.widget)
        ...
        self.widget1 = QtWidgets.QWidget(self.diskImageTab)
        self.widget1.setGeometry(QtCore.QRect(10, 20, 621, 651))
        ...
        self.diskImageSource = QtWidgets.QLineEdit(self.widget1)
        self.diskImageSource.setObjectName("diskImageSource")
        self.horizontalLayout_4.addWidget(self.diskImageSource)
        self.diskImageSourceBtn = QtWidgets.QPushButton(self.widget1)
        ...
        self.hfsDisk = QtWidgets.QCheckBox(self.widget1)
        ...
        self.diskImageDestination = QtWidgets.QLineEdit(self.widget1)
        self.diskImageDestination.setObjectName("diskImageDestination")
        self.horizontalLayout_5.addWidget(self.diskImageDestination)
        self.diskImageDestinationBtn = QtWidgets.QPushButton(self.widget1)
        ...
        self.diskImageIdentifier = QtWidgets.QLineEdit(self.widget1)
        ...
        self.diskImageOutput = QtWidgets.QTextEdit(self.widget1)
        self.diskImageOutput.setObjectName("diskImageOutput")
        self.verticalLayout_13.addWidget(self.diskImageOutput)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setSpacing(6)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.diskImageCancelBtn = QtWidgets.QPushButton(self.widget1)
        self.diskImageCancelBtn.setObjectName("diskImageCancelBtn")
        self.horizontalLayout_6.addWidget(self.diskImageCancelBtn)
        self.diskImageStartScan = QtWidgets.QPushButton(self.widget1)
        ...
        self.widget2 = QtWidgets.QWidget(self.optionsTab)
        self.widget2.setGeometry(QtCore.QRect(10, 20, 422, 430))
        ...
        self.md5 = QtWidgets.QRadioButton(self.widget2)
        self.md5.setChecked(True)
        self.md5.setObjectName("md5")
        self.buttonGroup = QtWidgets.QButtonGroup(Brunnhilde)
        self.buttonGroup.setObjectName("buttonGroup")
        self.buttonGroup.addButton(self.md5)
        self.verticalLayout_2.addWidget(self.md5)
        self.sha1 = QtWidgets.QRadioButton(self.widget2)
        self.sha1.setObjectName("sha1")
        self.buttonGroup.addButton(self.sha1)
        self.verticalLayout_2.addWidget(self.sha1)
        self.sha256 = QtWidgets.QRadioButton(self.widget2)
        self.sha256.setObjectName("sha256")
        self.buttonGroup.addButton(self.sha256)
        self.verticalLayout_2.addWidget(self.sha256)
        self.sha512 = QtWidgets.QRadioButton(self.widget2)
        self.sha512.setObjectName("sha512")
        self.buttonGroup.addButton(self.sha512)
        self.verticalLayout_2.addWidget(self.sha512)
        ...
        self.removeFiles = QtWidgets.QCheckBox(self.widget2)
        self.removeFiles.setObjectName("removeFiles")
        self.verticalLayout_3.addWidget(self.removeFiles)
        self.resForks = QtWidgets.QCheckBox(self.widget2)
        ...
        self.scanArchives = QtWidgets.QCheckBox(self.widget2)
        self.scanArchives.setChecked(True)
        self.scanArchives.setObjectName("scanArchives")
        self.verticalLayout_3.addWidget(self.scanArchives)
        self.sfWarnings = QtWidgets.QCheckBox(self.widget2)
        self.sfWarnings.setChecked(True)
        self.sfWarnings.setObjectName("sfWarnings")
        self.verticalLayout_3.addWidget(self.sfWarnings)
        self.bulkExtractor = QtWidgets.QCheckBox(self.widget2)
        self.bulkExtractor.setObjectName("bulkExtractor")
        self.verticalLayout_3.addWidget(self.bulkExtractor)
        self.throttleSiegfried = QtWidgets.QCheckBox(self.widget2)
        self.throttleSiegfried.setObjectName("throttleSiegfried")
        self.verticalLayout_3.addWidget(self.throttleSiegfried)
    ...
    def retranslateUi(self, Brunnhilde):
        ...
        self.label_7.setText(_translate("Brunnhilde", "<html><head/><body><p><span style=\" font-weight:600;\">Output</span></p></body></html>"))
        ...
        self.label_12.setText(_translate("Brunnhilde", "<html><head/><body><p><span style=\" font-weight:600;\">Output</span></p></body></html>"))
